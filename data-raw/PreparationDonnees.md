...
Les données utilisées sont les données du dump sql de la base importées
...
On ne conserve que les données ayant une qualification correcte et
correspondant à des protocoles permettant d’avoir une vision peuplement
(les protocoles ciblant des espèces particulières ne sont pas
conservés).
...
> il y a un problème avec l’axe des y pour certaines chroniques. La
> limite maxi coupe les valeurs (maxi de 108 environ pour les opérations
> retenues -\> voir comment on gère ces cas de figure
